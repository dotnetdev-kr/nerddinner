...
<asp:Content ID="aboutContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="about">
         <p><img src="<%=Url.Content("~/Content/nerd.jpg")%>" height="200" style="float:left; padding-right:20px" alt="Picture of a huge nerd."/>Are you a huge nerd? Perhaps a geek? No? Maybe a dork, dweeb or wonk. 
         ...
         <p>We're free and fun. <a href="<%=Url.Content("~/")%>">Find a dinner near you</a>, or <a href="<%=Url.Content("~/dinners/create")%>">host a dinner</a>. Be social.</p>
